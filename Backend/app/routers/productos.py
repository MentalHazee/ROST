...
@router.patch("/{item_id}", response_model=ProductoRead)
...
@router.post("/{producto_id}/categorias", response_model=ProductoCategoriaLinkRead, status_code=201)
...
@router.delete("/{producto_id}/categorias/{categoria_id}", status_code=204)
...
@router.post("/{producto_id}/ingredientes", response_model=ProductoIngredienteLinkRead, status_code=201)
